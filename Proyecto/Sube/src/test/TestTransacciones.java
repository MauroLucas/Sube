...
public class TestTransacciones {
	...
	public static void main(String[] args) {
		...
		try {
			...
			TransaccionABM.getInstance().agregarViajeTren(3,Funciones.traerFecha(2018,5,10,9,0,0),TarjetaSubeABM.getInstance().traerTarjetaSube(123),TransportePublicoABM.getInstance().traer((long)1),ParadaABM.getInstance().traer((long)1),ParadaABM.getInstance().traer((long)1));
